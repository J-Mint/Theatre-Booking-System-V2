...
//	}
	...
	public ShowDetailedFrame(int performanceID) {
		...
		DBC.connect();
		String query = "SELECT performance_ID, show_name, type, description, date, stage_time, duration, circle_price, stall_price FROM performances JOIN shows on performances.show_id = shows.show_id WHERE performance_id ="+performanceID;
		...
		btnContinue.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				BookingFrame boframe = new BookingFrame();
