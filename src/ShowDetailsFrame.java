...
public class ShowDetailsFrame extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShowDetailsFrame frame = new ShowDetailsFrame(1);
	 ...
	 */
	public ShowDetailsFrame(int performanceID) {
		...
		headerLabel.setText("You are booking tickets to see: " + performanceID);
